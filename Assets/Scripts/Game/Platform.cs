...
public class Platform : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            randomHiz = Random.Range(1.0f, 2.0f);
        }
       
        float objeGenisligi = polygonCollider2D.bounds.size.x / 2;
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        if (collider.gameObject.tag == "Ayaklar")
        {
            ...
            GameObject.FindGameObjectWithTag("Player").GetComponentInChildren<OyuncuHareket>().ZiplamaSifirlama();
        }
    }
}
